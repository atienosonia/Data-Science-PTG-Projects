...
In the folder `Dataset` are movie datasets from:

* [Box Office Mojo](https://www.boxofficemojo.com/)
* [The Numbers](https://www.the-numbers.com/)

The datasets have been merged to form the movies data. You can find the link to the data you will be using **[Here](https://github.com/atienosonia/Data-Science-PTG-Projects/blob/master/Dataset/movies_data.csv)**, on your right you have a download icon, click on that to have the data available to your desktop
